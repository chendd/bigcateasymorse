...
public class GetUsersOrderByCommentCountAction extends BaseAction{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		getAllService().getUsersOrderByCommentCount(pagination);
		...
		for (User user : pagination.getResults()) {
			...
			jsonUser.put("commentCount", user.getCommentCount());
