...
<div class="module">
<div class="title"><span><a href="<%=request.getContextPath()%>/group/${group.id }">返回${group.name }</a></span><h2>创建新话题</h2></div>
<div class="reDiv">
			<div id="mss" 
...
${message }</div>
<form action="<%=request.getContextPath()%>/createTopic.do" method="post" name="form1" id="form1" onsubmit="return checkit();">
<table width="80%">
<tr><td width="10%">标题</td><td width="90%" ><div align="left"><input type="text" id="title" name="title"/><input type="hidden"  name="id" value="${group.id }"/></div></td></tr>
<tr><td>内容</td><td>
