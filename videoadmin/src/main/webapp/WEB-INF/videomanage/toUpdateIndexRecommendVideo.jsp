...
<div id="photo" style="display: none">
 <form name="picForm" action="updateIndexRecommendVideo.do?id=${video.id }&type=image" method="post"
...
<form action="updateIndexRecommendVideo.do" method="post" name="form">
