...
<DIV class="dianping_box">
                  <UL>
                    ...
                    <LI>简介：${item.hotelIntroduce }
					</LI>
					 
                    <LI><SPAN><A  href="<%=request.getContextPath()%>/addcriticism.do?id=${item.id}" target="blank">[查看详细]</A></SPAN><SPAN style="color:#999999"></SPAN></LI>
					<LI>
					<LI><IMG src="<%=request.getContextPath() %>/pinglun/icon11.gif"> 
