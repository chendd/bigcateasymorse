...
public class DailyChannelDaoImpl extends SqlMapClientDaoSupport implements
	...
	public List<DailyChannel> getDailyChannels() throws DataAccessException {
		return (List<DailyChannel>)getSqlMapClientTemplate().queryForList("getDailyChannels");
	...
	public List<DailyChannel> getSimpleDailyChannels(Long userId)
		...
		return ( List<DailyChannel>)getSqlMapClientTemplate().queryForList("getSimpleDailyChannels",userId);
	}
