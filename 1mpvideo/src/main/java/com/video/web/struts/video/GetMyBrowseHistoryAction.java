...
public class GetMyBrowseHistoryAction extends BaseAction {
	@Override
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		pagination.setNo(no);
		pagination.setSize(SomeStatic.VIDEO_BROWSEHISTORY_PAGESIZE);

		getAllService().getBrowseHistoryByUserId(pagination);
