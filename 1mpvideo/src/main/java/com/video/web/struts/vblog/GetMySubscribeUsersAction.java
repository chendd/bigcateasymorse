...
public class GetMySubscribeUsersAction extends BaseAction{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		for (SubscribeUser subscribeUser : pagination.getResults()) {
			...
			jsonUser.put("friendCount", subscribeUser.getPassiveUser()
					.getFriendCount());
			jsonUser.put("beSubscribeCount", subscribeUser.getPassiveUser()
					.getBeSubscribeCount());
			jsonUser
					.put("score", subscribeUser.getPassiveUser().getScore());

			jsonUser.put("videoCount", subscribeUser.getPassiveUser()
					.getVideoCount());
