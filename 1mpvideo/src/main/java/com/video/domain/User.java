...
public class User implements Serializable {
	...
	private Integer browseCount; // 该用户所有视频被浏览次数
	private Integer commentCount;// 该用户所有视频被评论次数
	private Integer collectionCount;// 该用户所有视频被收藏次数
	private Integer pointSum;// 该 用户所有视频评分总和
	...
	public int getBeSubscribeCount() {
		return beSubscribeCount;
	}

	public void setBeSubscribeCount(int beSubscribeCount) {
		this.beSubscribeCount = beSubscribeCount;
	}

	public int getAge() {
		if (this.birthday != null) {
			return UtilMethod.getAge(this.birthday);
		} else {
			return this.age;
		}
