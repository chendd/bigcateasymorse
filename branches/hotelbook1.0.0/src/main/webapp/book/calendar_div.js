...
function showCalendar(sImg,bOpenBound,sFld1,sFld2,sCallback)
{
	...
	cf.style.top=(document.documentElement.clientHeight-(eT-sT)-eH>=cf.height)?eT+eH:eT-cf.height;
	cf.style.left=(document.documentElement.clientWidth-(eL-sL)>=cf.width)?eL:eL+eW-cf.width;
